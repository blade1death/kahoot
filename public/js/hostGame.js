...
socket.on('gameQuestions', function(data){
    ...
    document.getElementById('playersAnswered').innerHTML = "Игроков ответили 0 / " + data.playersInGame;
    updateTimer();
});

socket.on('updatePlayersAnswered', function(data){
   document.getElementById('playersAnswered').innerHTML = "Игроков ответили " + data.playersAnswered + " / " + data.playersInGame; 
});
...
socket.on('GameOver', function(data){
    ...
    document.getElementById('question').innerHTML = "ИГРА ОКОНЧЕНА";
